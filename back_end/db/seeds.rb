...
Game.create(seconds_left: 60, card_pairs_left: 8, user_id: 1, baby_id: 3, name: "DOMINATION")
Game.create(seconds_left: 43, card_pairs_left: 2, user_id: 1, baby_id: 2, name: "Know UR Worth")
Game.create(seconds_left: 6, card_pairs_left: 4, user_id: 1, baby_id: 6, name: "Listen UPPP")
